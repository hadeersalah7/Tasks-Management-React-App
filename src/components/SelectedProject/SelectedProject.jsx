...
export default function SelectedProject({ projects, onDelete, onAddTask, onDeleteTask, tasks }) {
    const formattedDate = new Date(projects.dueDate).toLocaleDateString("en-US", { year: '2-digit', month: 'short', day: "2-digit" })
    return (
